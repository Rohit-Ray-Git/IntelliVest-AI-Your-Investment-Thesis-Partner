...
class ProductionIntelliVestAI:
    ...
    async def _run_full_analysis(self, request: AnalysisRequest) -> Dict[str, Any]:
        ...
        if result['status'] == 'success':
            return {
                ...
                "thesis": "Investment thesis generated",
                "critique": "Thesis critique completed",
                "full_result": result['result'],
                "models_used": result.get('agents_used', []),
                "fallback_count": 0,  # CrewAI handles internally
                "confidence_score": 0.85  # High confidence for full analysis
            }
        else:
    ...
    def get_system_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "advanced_fallback_status": self.fallback_system.get_system_status(),
