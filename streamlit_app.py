...
from production_integration import ProductionIntelliVestAI, AnalysisRequest, AnalysisResult, TaskType
    ...
    def render_combined_qa_section(self):
        ...
        with col2:
            ...
            if suggested_questions:
                ...
                # Display suggested questions in 2-column layout with 2 examples each
                col1, col2 = st.columns(2)
                
                with col1:
                    # First column: Examples 1 and 2
                    for i in range(0, min(2, len(suggested_questions))):
                        st.markdown(f"""
                        <div style="background: rgba(0,0,0,0.03); 
                                    padding: 1rem; 
                                    border-radius: 8px; 
                            ...
                            <p style="margin: 0.5rem 0 0 0; color: #6c757d; font-size: 0.9rem;">{suggested_questions[i]}</p>
                        </div>
                        """, unsafe_allow_html=True)
                
                with col2:
                    # Second column: Examples 3 and 4
                    for i in range(2, min(4, len(suggested_questions))):
                        st.markdown(f"""
                        <div style="background: rgba(0,0,0,0.03); 
                                    padding: 1rem; 
                                    border-radius: 8px; 
                ...
                if question.strip():
                    with st.spinner("🤔 Thinking..."):
                        try:
                            ...
                            # Enhanced answer display in full width - FIXED COLOR CONTRAST
                            st.markdown(f"""
                            <div style="background: #2c3e50; 
                                        ...
                                        margin: 1rem 0;
                                        max-width: 100%;">
                                <div style="line-height: 1.8; color: #ffffff !important; font-size: 1.1rem; font-weight: 500; text-shadow: none;">
